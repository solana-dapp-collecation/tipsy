...
const routes: Routes = [
  ...
  {
    path: RouteNames.USER_PREFIX + "/:receiver/" + RouteNames.solanaS + "/:sender",
    component: solanaPostsPageComponent,
    pathMatch: "full",
  },
  ...
  {
    path: RouteNames.TUTORIAL + "/" + RouteNames.solanaS,
    component: solanaTutorialPageComponent,
    pathMatch: "full",
  },
  {
